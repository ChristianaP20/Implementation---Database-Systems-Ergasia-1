...
typedef struct {
    BF_Block *block; /* δείκτης σε block */
    int last_block_id; /* αριθμός τελευταίου block στο οποίο έγινε εγγραφή */
    int records_block_size; // Μέγεθος ενός block στο οποίο μπορούν να αποθηκευτούν εγγραφές
    char* flag; // Ένα flag για να ελέγχουμε αν το αρχείο είναι heap file
} HP_info;     

typedef struct {
  int record_block_size; // The number of records in a block
} HP_block_info;
